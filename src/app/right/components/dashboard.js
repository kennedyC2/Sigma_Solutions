    ...
    return (
        <React.Fragment>
            <header className="d-flex justify-content-between">
                <div className="searchBar" style={{ width: "60%" }}>
                    <form action="" method="post">
                        <div class="dir input-group flex-nowrap">
                            <button type="submit" style={{ paddingBottom: "3px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#5e5e5e" class="bi bi-search-heart" viewBox="0 0 16 16">
                ...
                <div className="container desktop_hdr d-flex justify-content-end">
                    ...
                    <div className="d-flex">
                        ...
                        <div style={{ textAlign: "left" }}>
                            <p style={{ fontSize: "13px", margin: "0" }}>Kennedy C. Young</p>
                            <p style={{ fontSize: "13px", margin: "0" }}>Administrator</p>
                        </div>
                    </div>
                </div>
            </header>

            <div className="container d-flex justify-content-between date_time position-sticky top-0 start-0">
                <div>
            ...
            <div className="recent d-flex justify-content-between py-3">
                <div className="recent_1"></div>
                <div className="recent_2"></div>
            </div>

            <div className="d d-flex justify-content-between py-2">
                <div className="d1"></div>
                <div className="d2"></div>
                <div className="d3"></div>
            </div>

            <div className="bdt py-3">
                <div></div>
            </div>
        </React.Fragment>
    );
